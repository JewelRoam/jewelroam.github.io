...
function About() { return <Page title="About" intro="JewelRoam 是一个私人影像与文字档案。"><div className="max-w-2xl space-y-6 text-lg leading-9 text-[#20211f]/75"><p>我在路上拍照，也在回到房间之后写下那些没有被相机记录的部分。这里没有目的地清单，只有一些关于光线、陌生城市和日常停顿的观察。</p><p>我曾经偶尔使用 Apple 的 Notes 或 Journal app 记录想法，但它们始终没有提供一个足够顺手的图文编辑工作流。于是，我为 JewelRoam 开发了 Capture：一个更贴近自己写作方式的编辑器。</p><p>在 Capture 中，图片会直接嵌入文章，保存为 Base64 编码，并随文章一起导出为 JSON。这样既方便在本地继续整理，也方便后续交给 Agent 代理完成摘要、图片 metadata、R2 上传和上线准备。</p></div></Page>; }
