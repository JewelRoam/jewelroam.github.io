...
const ArticleEditor = import.meta.env.DEV ? lazy(() => import("./components/ArticleEditor").then((module) => ({ default: module.ArticleEditor }))) : null;
...
function EditorRoute() { if (!ArticleEditor) return <Navigate to="/" replace />; return <Suspense fallback={<div className="mx-auto max-w-6xl px-6 py-20 text-sm text-[#20211f]/55">正在打开编辑器…</div>}><ArticleEditor /></Suspense>; }
